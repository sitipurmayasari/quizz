                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="general-tab" data-toggle="tab" href="#general" role="tab" aria-controls="general" aria-selected="true">Data User</a>
                            </li>
                            {{-- <li class="nav-item">
                            ...
                            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                <form action="{{ route('user.update', $user->id) }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-2 col-sm-2 label-align" for="name">Nama <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-2 col-sm-2 label-align">Role </span>
                                        </label>
                                    ...
                                    <div class="row input_row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label col-md-2 col-sm-2 col-xs-12">Keterangan/Asal Sekolah</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="asal" name="asal"  class="form-control col-md-8 col-xs-12" value="{{$user->asal}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="password" name="password" placeholder="Masukkan kata sandi baru pengguna atau biarkan kosong" class="form-control">
                                        </div>
                                    </div>
