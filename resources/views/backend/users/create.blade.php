        ...
        <div class="x_content">
            ...
            <form method="POST" action="{{ route('user.store') }}" class="">
                ...
                <div class="row input_row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="asal" name="asal"  class="form-control col-md-8 col-xs-12">
                ...
                <div class="row input_row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12">Ulangi Password <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
